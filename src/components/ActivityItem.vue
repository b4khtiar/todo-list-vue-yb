...
<template>
    <div class="p-4 border rounded-lg shadow bg-white h-60 flex flex-col justify-between" data-cy="activity-item">
        <div class="h-full" @click="emit('detail')">
        ...
        <div class="flex justify-between text-slate-600">
            ...
            <div @click="handleDelete" class="cursor-pointer" data-cy="activity-item-delete-button">
